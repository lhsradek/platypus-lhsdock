...
docker network create lhsdock-local-dev-network
...
docker run -it --name platypus-lhsdock --mount source=lhsdock,destination=/usr/share/nginx/html,readonly,target=/root/bin/lhsdock --volume /root/platypus-lhsdock/lhsvol:/root/bin/lhsvol --network lhsdock-local-dev-network lhsdock:v3 sh
