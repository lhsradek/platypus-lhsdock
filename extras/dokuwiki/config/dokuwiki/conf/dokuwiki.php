...
$conf['refcheck']    = 0;                //check for references before deleting media files
$conf['gdlib']       = 0;                //the GDlib version (0, 1 or 2) 2 tries to autodetect
$conf['im_convert']  = '';               //path to ImageMagicks convert (will be used instead of GD)
$conf['jpg_quality'] = '100';            //quality of compression when scaling jpg images (0-100)
$conf['png_quality'] = '100';            //quality of compression when scaling png images (0-100)
$conf['fetchsize']   = 1;                //maximum size (bytes) fetch.php may download from extern, disabled by default
